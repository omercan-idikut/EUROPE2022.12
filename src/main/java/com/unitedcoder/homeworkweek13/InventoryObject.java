...
public class InventoryObject {
    ...
    public InventoryObject(String retailPrice, String salePrice, String costPrice) {
    ...
    public InventoryObject(String productName, String productCode, String productWeight,
